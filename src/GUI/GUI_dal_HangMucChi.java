...
public class GUI_dal_HangMucChi extends javax.swing.JDialog {
    ...
    private void tblHangMucChiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblHangMucChiMouseClicked
        ...
        if (tblHangMucChi.getValueAt(row, column) != null && tblHangMucChi.getValueAt(row, column + 1) != null || tblHangMucChi.getValueAt(row, column) != null && tblHangMucChi.getValueAt(row, column - 1) != null) {
            fill(row);
        } else if (tblHangMucChi.getValueAt(row, column) == null && tblHangMucChi.getValueAt(row, column - 1) != null) {
            edit();
            load();
        } else if (tblHangMucChi.getValueAt(row, column) == null && tblHangMucChi.getValueAt(row, column - 1) == null) {
            delete(row);
