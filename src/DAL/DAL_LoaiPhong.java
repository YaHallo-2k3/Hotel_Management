...
public class DAL_LoaiPhong {
    ...
    public static ResultSet findGiaPhong(String maLoaiPhong) {
        String sqlSelect = "SELECT * FROM LoaiPhong JOIN Phong ON Phong.MaLoaiPhong = LoaiPhong.MaLoaiPhong WHERE MaPhong = ?";
