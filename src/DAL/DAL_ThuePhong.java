...
public class DAL_ThuePhong {
    ...
    public static void edit(DTO_ThuePhong thuePhong) {
        String sqlUpdate = "UPDATE ThuePhong SET MaPhong = ?, MaTrangThaiPhong = ?, MaNhanVien = ?, CONVERT(VARCHAR, NgayTao = ?), CONVERT(VARCHAR, NgayDen = ?), CONVERT(VARCHAR, NgayDi = ?), CCCD = ?, SoLuongKhach = ?, GhiChu = ?, GiamGia = ?, TienCoc = ? WHERE MaPhieuThue = ?";
    ...
    public static ResultSet select() {
        String sqlSelect = "SELECT * FROM ThuePhong ORDER BY MaPhieuThue";
