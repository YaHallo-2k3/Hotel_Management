...
import HELPER.BlankPlotChart;
import HELPER.BlankPlotChatRender;
import HELPER.SeriesSize;
...
public class LineChart extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        blankPlotChart = new HELPER.BlankPlotChart();

        setBackground(new java.awt.Color(255, 255, 255));
        setMinimumSize(new java.awt.Dimension(600, 400));

        pnlLineChart.setBackground(new java.awt.Color(255, 255, 255));
        pnlLineChart.setMinimumSize(new java.awt.Dimension(600, 400));
        pnlLineChart.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        panelLegend.setBackground(new java.awt.Color(255, 255, 255));
        panelLegend.setMinimumSize(new java.awt.Dimension(580, 30));
        panelLegend.setOpaque(false);
        panelLegend.setPreferredSize(new java.awt.Dimension(580, 30));
        panelLegend.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.CENTER, 5, 0));
        pnlLineChart.add(panelLegend, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 360, 580, 30));

        blankPlotChart.setForeground(new java.awt.Color(62, 73, 95));
        blankPlotChart.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        blankPlotChart.setMinimumSize(new java.awt.Dimension(600, 350));
        blankPlotChart.setPreferredSize(new java.awt.Dimension(600, 350));
        pnlLineChart.add(blankPlotChart, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 600, 350));
    ...
    private HELPER.BlankPlotChart blankPlotChart;
