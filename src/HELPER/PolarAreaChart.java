...
public class PolarAreaChart extends javax.swing.JComponent {
    ...
    private void initComponents() {
        ...
        pnlPolarAreaChart = new javax.swing.JPanel();
        panelLegend = new javax.swing.JPanel();

        setBackground(new java.awt.Color(255, 255, 255));
        setMinimumSize(new java.awt.Dimension(300, 300));

        pnlPolarAreaChart.setBackground(new java.awt.Color(255, 255, 255));
        pnlPolarAreaChart.setMinimumSize(new java.awt.Dimension(300, 300));
        pnlPolarAreaChart.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        panelLegend.setBackground(new java.awt.Color(255, 255, 255));
        panelLegend.setMinimumSize(new java.awt.Dimension(280, 30));
        panelLegend.setOpaque(false);
        panelLegend.setPreferredSize(new java.awt.Dimension(280, 30));
        panelLegend.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.CENTER, 5, 0));
        pnlPolarAreaChart.add(panelLegend, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 260, 280, 30));

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(this);
        this.setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(pnlPolarAreaChart, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
    ...
    private javax.swing.JPanel pnlPolarAreaChart;
